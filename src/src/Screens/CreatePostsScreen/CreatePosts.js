...
<View style={ styles.postContainer }>
   ...
   <View style={ styles.postForm }>
      <TextInput style={ styles.postName } placeholder="Название..." inputMode="text" onChangeText={ inputTitlte }/>
      <TextInput style={ styles.postName } placeholder="Местность..." inputMode="navigation" value = { inputRegion }/>
